...
{
    public class Single_Digit_Addition_Worksheets_50 : IPrint
    {
        ...
        public Single_Digit_Addition_Worksheets_50()
        {
            PagesCount = 50;
            PresentationId = "1LYeQC_Z-eiZHhHv2Qt5rlzSWnK0QcysJEkodzr4RKyM";
        }
