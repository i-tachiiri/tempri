...
{
    public class Single_Digit_Addition_Worksheets_10 : IPrint
    {
        private List<int> answerIndex = new List<int> { 4, 10 };
        public int PagesCount { get; private set; }
        private int Score = 10;
        private string PrintName = "Single-Digit Addition";
        public string PresentationId { get; private set; }
        public Single_Digit_Addition_Worksheets_10()
        {
            PagesCount = 10;
            PresentationId = "1H9kneVZWKrwAhsrBTDY54rmpVxid1YFFpxigZY-eYq4";
        }
