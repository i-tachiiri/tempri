...
{
    public class Vertical_Addition_1Digit_1Digit_10 : IPrint
    {
        ...
        public Vertical_Addition_1Digit_1Digit_10()
        {
            PresentationId = "1efn3hywkYw0rYwsJvRy2jwf4VJWyzxXX-lPWNR-P7rQ";
            PrintName = "Vertical Addition 1-Digit + 1-Digit";
            PagesCount = 10;
        ...
        public List<HeaderConfig> GetHeaderConfigs()
        {
            ...
            for (var i = 0; i < PagesCount; i++)
            {
                ...
                // Answer Config
                var answerPrintType = "Answer Keys";
