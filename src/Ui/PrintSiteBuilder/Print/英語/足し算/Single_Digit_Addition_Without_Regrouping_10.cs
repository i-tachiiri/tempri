...
{
    public class Single_Digit_Addition_Without_Regrouping_10 : IPrint
    {
        ...
        public Single_Digit_Addition_Without_Regrouping_10()
        {
            PresentationId = "1tp_5w7-uYXrHegfU9RVWd6kP3U5fZUmce6X4tJYAoxk";
            PagesCount = 10;
        }
