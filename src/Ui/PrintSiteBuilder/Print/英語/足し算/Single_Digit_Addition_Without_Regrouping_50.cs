...
namespace PrintSiteBuilder.Print.英語.足し算
{
    public class Single_Digit_Addition_Without_Regrouping_50 : IPrint
    {
        private List<int> answerIndex = new List<int> { 4, 10 };
        public int PagesCount { get; private set; }
        private int Score = 10;
        private string PrintName = "Single Digit Addition Without Regrouping";
        public string PresentationId { get; private set; }
        public Single_Digit_Addition_Without_Regrouping_50()
        {
            PresentationId = "1cvcjuAjVgn8iJcyj0WCqj-lkAfR6SYgBdG3DrVr4aFk";
            PagesCount = 50;
        }
        ...
        public List<HeaderConfig> GetHeaderConfigs()
        {
            ...
            {
                // Question Config
                var questionPrintType = "Worksheet";
                ...
                // Answer Config
                var answerPrintType = "Answer Key";
