...
{
    public class Single_Digit_Addition_Worksheets_30 : IPrint
    {
        ...
        public Single_Digit_Addition_Worksheets_30()
        {
            PagesCount = 30;
            PresentationId = "1Us-EY5c7Wzi-dTu_NuKVvtPaKWb9ZIBtE_kCo7O-XLc";
        }
