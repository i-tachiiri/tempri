...
{
    public class Single_Digit_Addition_With_Regrouping_50 : IPrint
    {
        private List<int> answerIndex = new List<int> { 4, 10 };
        public int PagesCount { get; private set; }
        private int Score = 10;
        private string PrintName = "Single Digit Addition With Regrouping";
        public string PresentationId { get; private set; }
        public Single_Digit_Addition_With_Regrouping_50()
        {
            PresentationId = "1ltnFtAzUaLH7grpxNV6thyO7uez8FKU_kX-5V8jczy4";
            PagesCount = 50;
        }
