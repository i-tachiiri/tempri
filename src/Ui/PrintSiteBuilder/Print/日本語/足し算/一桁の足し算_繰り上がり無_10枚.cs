...
{
    public class 一桁の足し算_繰り上がり無_10枚 : IPrint
    {
        private List<int> answerIndex = new List<int> { 4, 10 };
        public int PagesCount { get; private set; }
        private int Score = 10;
        private string PrintName = "ひとけたのたしざん(くりあがりなし)";
        public string PresentationId { get; private set; }
        public 一桁の足し算_繰り上がり無_10枚()
        {
            PresentationId = "1Ii2MZ644M_OrmjZ1IRIHKgTcJI426E5xvvpU6aBAf_A";
            PagesCount = 10;
        }
