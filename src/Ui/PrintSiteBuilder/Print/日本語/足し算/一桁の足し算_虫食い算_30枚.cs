...
{
    public class 一桁の足し算_虫食い算_30枚 : IPrint
    {
        private List<int> answerIndex = new List<int> { 2, 8 };
        public int PagesCount { get; private set; }
        private int Score = 10;
        private string PrintName = "むしくいざん ひとけたのたしざん";
        public string PresentationId { get; private set; }
        public 一桁の足し算_虫食い算_30枚()
        {
            PagesCount = 30;
            PresentationId = "18dEkWz72XWHcNMTgIkRdXHghgHgDSwkkNEaUxnOb_7E";
        }
