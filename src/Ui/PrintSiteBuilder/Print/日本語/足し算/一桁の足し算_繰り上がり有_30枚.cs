...
{
    public class 一桁の足し算_繰り上がり有_30枚 : IPrint
    {
        private List<int> answerIndex = new List<int> { 4, 10 };
        public int PagesCount { get; private set; }
        private int Score = 10;
        private string PrintName = "ひとけたのたしざん(くりあがり)";
        public string PresentationId { get; private set; }
        public 一桁の足し算_繰り上がり有_30枚()
        {
            PresentationId = "1VFwpMyRT0NQMJTeXXhmT-bNq7dnghhGw_XRYW215xZ8";
            PagesCount = 30;
        }
