...
{
    public class 筆算_四桁の足し算_30枚 : IPrint
    {
        ...
        private List<List<List<int>>> Coordinates = new List<List<List<int>>>
            {
                new List<List<int>>
                {
                    new List<int> { 1, 2 }, new List<int> { 1, 3 }, new List<int> { 1, 4 }, new List<int> { 1, 5 },
                    new List<int> { 2, 1 }, new List<int> { 2, 2 }, new List<int> { 2, 3 }, new List<int> { 2, 4 }, new List<int> { 2, 5 },
                    new List<int> { 3, 1 }, new List<int> { 3, 2 }, new List<int> { 3, 3 }, new List<int> { 3, 4 }, new List<int> { 3, 5 },
                },
                new List<List<int>>
                {
                    new List<int> { 1, 8 }, new List<int> { 1, 9 }, new List<int> { 1, 10 }, new List<int> { 1, 11 },
                    new List<int> { 2, 7 }, new List<int> { 2, 8 }, new List<int> { 2,  9 }, new List<int> { 2, 10 }, new List<int> { 2, 11 },
                    new List<int> { 3, 7 }, new List<int> { 3, 8 }, new List<int> { 3,  9 }, new List<int> { 3, 10 }, new List<int> { 3, 11 },
                },
                new List<List<int>>
                {
                    new List<int> { 1, 14 }, new List<int> { 1, 15 }, new List<int> { 1, 16 }, new List<int> { 1, 17 },
                    new List<int> { 2, 13 }, new List<int> { 2, 14 }, new List<int> { 2, 15 }, new List<int> { 2, 16 }, new List<int> { 2, 17 },
                    new List<int> { 3, 13 }, new List<int> { 3, 14 }, new List<int> { 3, 15 }, new List<int> { 3, 16 }, new List<int> { 3, 17 },
                },
                new List<List<int>>
                {
                    new List<int> { 5, 2 }, new List<int> { 5, 3 }, new List<int> { 5, 4 }, new List<int> { 5, 5 },
                    new List<int> { 6, 1 }, new List<int> { 6, 2 }, new List<int> { 6, 3 }, new List<int> { 6, 4 }, new List<int> { 6, 5 },
                    new List<int> { 7, 1 }, new List<int> { 7, 2 }, new List<int> { 7, 3 }, new List<int> { 7, 4 }, new List<int> { 7, 5 },
                },
                new List<List<int>>
                {
                    new List<int> { 5, 8 }, new List<int> { 5, 9 }, new List<int> { 5, 10 }, new List<int> { 5, 11 },
                    new List<int> { 6, 7 }, new List<int> { 6, 8 }, new List<int> { 6,  9 }, new List<int> { 6, 10 }, new List<int> { 6, 11 },
                    new List<int> { 7, 7 }, new List<int> { 7, 8 }, new List<int> { 7,  9 }, new List<int> { 7, 10 }, new List<int> { 7, 11 },
                },
                new List<List<int>>
                {
                    new List<int> { 5, 14 }, new List<int> { 5, 15 }, new List<int> { 5, 16 }, new List<int> { 5, 17 },
                    new List<int> { 6, 13 }, new List<int> { 6, 14 }, new List<int> { 6, 15 }, new List<int> { 6, 16 }, new List<int> { 6, 17 },
                    new List<int> { 7, 13 }, new List<int> { 7, 14 }, new List<int> { 7, 15 }, new List<int> { 7, 16 }, new List<int> { 7, 17 },
                },
                new List<List<int>>
                {
                    new List<int> {  9, 2 }, new List<int> {  9, 3 }, new List<int> {  9, 4 }, new List<int> {  9, 5 },
                    new List<int> { 10, 1 }, new List<int> { 10, 2 }, new List<int> { 10, 3 }, new List<int> { 10, 4 }, new List<int> { 10, 5 },
                    new List<int> { 11, 1 }, new List<int> { 11, 2 }, new List<int> { 11, 3 }, new List<int> { 11, 4 }, new List<int> { 11, 5 },
                },
                new List<List<int>>
                {
                    new List<int> {  9, 8 }, new List<int> {  9, 9 }, new List<int> {  9, 10 }, new List<int> {  9, 11 },
                    new List<int> { 10, 7 }, new List<int> { 10, 8 }, new List<int> { 10,  9 }, new List<int> { 10, 10 }, new List<int> { 10, 11 },
                    new List<int> { 11, 7 }, new List<int> { 11, 8 }, new List<int> { 11,  9 }, new List<int> { 11, 10 }, new List<int> { 11, 11 },
                },
                new List<List<int>>
                {
                    new List<int> {  9, 14 }, new List<int> {  9, 15 }, new List<int> {  9, 16 }, new List<int> {  9, 17 },
                    new List<int> { 10, 13 }, new List<int> { 10, 14 }, new List<int> { 10, 15 }, new List<int> { 10, 16 }, new List<int> { 10, 17 },
                    new List<int> { 11, 13 }, new List<int> { 11, 14 }, new List<int> { 11, 15 }, new List<int> { 11, 16 }, new List<int> { 11, 17 },
                },
            };
        ...
        public 筆算_四桁の足し算_30枚()
        {
            PresentationId = "1P0NGC4HC8sig33viv7A59biKysyGYAEa-WC9Nsdc8YQ";
            PrintName = "ひっさん(よんけたのたしざん)";
            PagesCount = 30;
        ...
        public List<List<string>> GetQuestions1()
        {
            ...
            {
                int i = random.Next(1001, 10000); // 4-digit number > 1000
                int j = random.Next(1001, 10000);
                int sum = i + j;
                ...
                var Number1 = i.ToString("D4");
                var Number2 = j.ToString("D4");
