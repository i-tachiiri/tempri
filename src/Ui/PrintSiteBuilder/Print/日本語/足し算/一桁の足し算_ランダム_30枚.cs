...
{
    public class 一桁の足し算_ランダム_30枚 : IPrint
    {
        private List<int> answerIndex = new List<int> { 4, 10 };
        public int PagesCount { get; private set; }
        private int Score = 10;
        private string PrintName = "ひとけたのたしざん";
        public string PresentationId { get; private set; }
        public 一桁の足し算_ランダム_30枚()
        {
            PagesCount = 30;
            PresentationId = "1_7Vwz6MgJ8OpMU2fYjWSEgjA32AobQAnCBkFtkQefRM";
        }
