...
{
    public class 筆算_二桁_一桁の足し算_30枚 : IPrint
    {
        ...
        private List<List<List<int>>> Coordinates = new List<List<List<int>>>
            {
                new List<List<int>>{ new List<int> { 1, 2 }, new List<int> { 1, 3 }, new List<int>{2,1},new List<int>{2,3}, new List<int> { 3, 2 },new List<int>{3,3} },
                new List<List<int>>{ new List<int> { 1, 6 }, new List<int> { 1, 7 }, new List<int>{2,5},new List<int>{2,7}, new List<int> { 3, 6 },new List<int>{3,7} },
                new List<List<int>>{ new List<int> { 1, 10 }, new List<int> { 1, 11 }, new List<int>{2,9},new List<int>{2,11}, new List<int> { 3, 10 },new List<int>{3,11} },
                new List<List<int>>{ new List<int> { 1, 14 }, new List<int> { 1, 15 }, new List<int>{2,13},new List<int>{2,15}, new List<int> { 3, 14 },new List<int>{3,15} },
                new List<List<int>>{ new List<int> { 5, 2 }, new List<int> { 5, 3 }, new List<int>{6,1},new List<int>{6,3}, new List<int> { 7, 2 },new List<int>{7,3} },
                new List<List<int>>{ new List<int> { 5, 6 }, new List<int> { 5, 7 }, new List<int>{6,5},new List<int>{6,7}, new List<int> { 7, 6 },new List<int>{7,7} },
                new List<List<int>>{ new List<int> { 5, 10 }, new List<int> { 5, 11 }, new List<int>{6,9},new List<int>{6,11}, new List<int> { 7, 10 },new List<int>{7,11} },
                new List<List<int>>{ new List<int> { 5, 14 }, new List<int> { 5, 15 }, new List<int>{6,13},new List<int>{6,15}, new List<int> { 7, 14 },new List<int>{7,15} },
                new List<List<int>>{ new List<int> { 9, 2 }, new List<int> { 9, 3 }, new List<int>{10,1},new List<int>{10,3}, new List<int> { 11, 2 },new List<int>{11,3} },
                new List<List<int>>{ new List<int> { 9, 6 }, new List<int> { 9, 7 }, new List<int>{10,5},new List<int>{10,7}, new List<int> { 11, 6 },new List<int>{11,7} },
                new List<List<int>>{ new List<int> { 9, 10 }, new List<int> { 9, 11 }, new List<int>{10,9},new List<int>{10,11}, new List<int> { 11, 10 },new List<int>{11,11} },
                new List<List<int>>{ new List<int> { 9, 14 }, new List<int> { 9, 15 }, new List<int>{10,13},new List<int>{10,15}, new List<int> { 11, 14 },new List<int>{11,15} },
        ...
        public 筆算_二桁_一桁の足し算_30枚()
        {
            PresentationId = "1hBABWBEbeZsG6LoMVETCsXMC9or72kjeiAv3nxlcBos";
            PrintName = "ふたけたとひとけたのひっさん";
            PagesCount = 30;
        ...
        public List<List<string>> GetQuestions1()
        {
            ...
            for (var i = 11; i < 100; i++)
            {
                for (var j = 1; j < 10; j++)
                {
                    ...
                    question.Add("+");
                    question.Add(j.ToString());

                    // Remove equal sign — directly add digits of the answer
                    foreach (var digit in (i + j).ToString())
                    {
                        question.Add(digit.ToString());
                    }
