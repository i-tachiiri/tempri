...
namespace PrintSiteBuilder.Print.日本語.九九
{
    public class 九九_6の段 : IPrint
    {
        ...
        public 九九_6の段()
        {
            PresentationId = "1AwJl89yoWZNFiUg_Yz_IeYZrl0cVlW8OlO4tKWMOYIo";
            PrintName = "九九(6の段)";
            PagesCount = 1;
        ...
        public List<List<string>> GetQuestions1()
        {
            var questions = new List<List<string>>
            {
                new List<string>{"ろく"," ","いち","が","ろく","6", "×", "1", "=", "6" },
                new List<string> { "ろく", " ", "に", " ", "じゅうに" ,"6", "× ", "2", "=", "12" },
                new List<string> { "ろく", " ", "さん", " ", "じゅうはち" ,"6", "× ", "3", "=", "18" },
                new List<string> { "ろく", " ", "し", " ", "にじゅうし" , "6", "× ", "4", "=", "24" },
                new List<string> { "ろく", " ", "ご", " ", "さんじゅう" ,"6", "× ", "5", "=", "30" },
                new List<string> { "ろく", " ", "ろく", " ", "さんじゅうろく" ,"6", "× ", "6", "=", "36" },
                new List<string> { "ろく", " ", "しち", " ", "しじゅうに","6", "× ", "7", "=", "42" },
                new List<string> { "ろく", " ", "は", " ", "しじゅうはち","6", "× ", "8", "=", "48" },
                new List<string> { "ろく", " ", "く", " ", "ごじゅうし","6", "×", "9", "=", "54" },
            };
            return questions;
        }
    }
