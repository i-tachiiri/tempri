...
namespace PrintSiteBuilder.Print.日本語.九九
{
    public class 九九_1の段 : IPrint
    {
        ...
        public 九九_1の段()
        {
            PresentationId = "1WjbFBHrKgF-hpKvttOCASDth1UaZcTt9juqaOJNIopA";
            PrintName = "九九(1の段)";
            PagesCount = 1;
        ...
        public List<List<string>> GetQuestions1()
        {
            var questions = new List<List<string>>
            {
                new List<string>{"いん"," ","いち","が","いち","1", "×", "1", "=", "1" },
                new List<string> { "いん", " ", "に", "が", "に" ,"1", "× ", "2", "=", "2" },
                new List<string> { "いん", " ", "さん", "が", "さん" ,"1", "× ", "3", "=", "3" },
                new List<string> { "いん", " ", "し", "が", "し" , "1", "× ", "4", "=", "4" },
                new List<string> { "いん", " ", "ご", "が", "ご" ,"1", "× ", "5", "=", "5" },
                new List<string> { "いん", " ", "ろく", "が", "ろく" ,"1", "× ", "6", "=", "6" },
                new List<string> { "いん", " ", "しち", "が", "しち","1", "× ", "7", "=", "7" },
                new List<string> { "いん", " ", "はち", "が", "はち","1", "× ", "8", "=", "8" },
                new List<string> { "いん", " ", "く", "が", "く","1", "×", "9", "=", "9" },
            };
            return questions;
        }
    }
