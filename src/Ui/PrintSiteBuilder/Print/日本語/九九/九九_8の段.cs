...
namespace PrintSiteBuilder.Print.日本語.九九
{
    public class 九九_8の段 : IPrint
    {
        ...
        public 九九_8の段()
        {
            PresentationId = "1IYbBnEa55xDelvx7UobOt9mqsVQYDblhj59q06Li6fQ";
            PrintName = "九九(8の段)";
            PagesCount = 1;
        ...
        public List<List<string>> GetQuestions1()
        {
            var questions = new List<List<string>>
            {
                new List<string>{"はち"," ","いち","が","はち","8", "×", "1", "=", "8" },
                new List<string> { "はち", " ", "に", " ", "じゅうろく" ,"8", "× ", "2", "=", "16" },
                new List<string> { "はち", " ", "さん", " ", "にじゅうし" ,"8", "× ", "3", "=", "24" },
                new List<string> { "はち", " ", "し", " ", "さんじゅうに" , "8", "× ", "4", "=", "32" },
                new List<string> { "はち", " ", "ご", " ", "しじゅう" ,"8", "× ", "5", "=", "40" },
                new List<string> { "はち", " ", "ろく", " ", "しじゅうはち" ,"8", "× ", "6", "=", "48" },
                new List<string> { "はち", " ", "しち", " ", "ごじゅうろく","8", "× ", "7", "=", "56" },
                new List<string> { "はっ", " ", "ぱ", " ", "ろくじゅうし","8", "× ", "8", "=", "64" },
                new List<string> { "はち", " ", "く", " ", "しちじゅうに","8", "×", "9", "=", "72" },
            };
            return questions;
        }
    }
