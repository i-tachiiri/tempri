...
namespace PrintSiteBuilder.Print.日本語.九九
{
    public class 九九_7の段 : IPrint
    {
        ...
        public 九九_7の段()
        {
            PresentationId = "1ZJTfNoZ6L1NXv6XNj1UOACR3gq1Txm2xkrYwAow92DM";
            PrintName = "九九(7の段)";
            PagesCount = 1;
        ...
        public List<List<string>> GetQuestions1()
        {
            var questions = new List<List<string>>
            {
                new List<string>{"しち"," ","いち","が","しち","7", "×", "1", "=", "7" },
                new List<string> { "しち", " ", "に", " ", "じゅうし" ,"7", "× ", "2", "=", "14" },
                new List<string> { "しち", " ", "さん", " ", "にじゅういち" ,"7", "× ", "3", "=", "21" },
                new List<string> { "しち", " ", "し", " ", "にじゅうはち" , "7", "× ", "4", "=", "28" },
                new List<string> { "しち", " ", "ご", " ", "さんじゅうご" ,"7", "× ", "5", "=", "35" },
                new List<string> { "しち", " ", "ろく", " ", "しじゅうに" ,"7", "× ", "6", "=", "42" },
                new List<string> { "しち", " ", "しち", " ", "しじゅうく","7", "× ", "7", "=", "49" },
                new List<string> { "しち", " ", "は", " ", "ごじゅうろく","7", "× ", "8", "=", "56" },
                new List<string> { "しち", " ", "く", " ", "ろくじゅうさん","7", "×", "9", "=", "63" },
            };
            return questions;
        }
    }
