...
namespace PrintSiteBuilder.Print.日本語.九九
{
    public class 九九_3の段 : IPrint
    {
        ...
        public 九九_3の段()
        {
            PresentationId = "1Dk8bH-zKYauMIAIp3GEOR1hbAr6XOs4QaSzzNIgVZcI";
            PrintName = "九九(3の段)";
            PagesCount = 1;
        ...
        public List<List<string>> GetQuestions1()
        {
            var questions = new List<List<string>>
            {
                new List<string>{"さん"," ","いち","が","さん","3", "×", "1", "=", "3" },
                new List<string> { "さん", " ", "に", "が", "ろく" ,"3", "× ", "2", "=", "6" },
                new List<string> { "さ", " ", "ざん", "が", "く" ,"3", "× ", "3", "=", "9" },
                new List<string> { "さん", " ", "し", " ", "じゅうに" , "3", "× ", "4", "=", "12" },
                new List<string> { "さん", " ", "ご", " ", "じゅうご" ,"3", "× ", "5", "=", "15" },
                new List<string> { "さぶ", " ", "ろく", " ", "じゅうはち" ,"3", "× ", "6", "=", "18" },
                new List<string> { "さん", " ", "しち", " ", "にじゅういち","3", "× ", "7", "=", "21" },
                new List<string> { "さん", " ", "ぱ", " ", "にじゅうし","3", "× ", "8", "=", "24" },
                new List<string> { "さん", " ", "く", " ", "にじゅうしち","3", "×", "9", "=", "27" },
            };
            return questions;
        }
    }
