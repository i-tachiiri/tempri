...
namespace PrintSiteBuilder.Print.日本語.九九
{
    public class 九九_4の段 : IPrint
    {
        ...
        public 九九_4の段()
        {
            PresentationId = "1tNyyRoJwG_uhczRL0jpDvdYYMJ8hJ0xC6RwapukeSn8";
            PrintName = "九九(4の段)";
            PagesCount = 1;
        ...
        public List<List<string>> GetQuestions1()
        {
            var questions = new List<List<string>>
            {
                new List<string>{"し"," ","いち","が","し","4", "×", "1", "=", "4" },
                new List<string> { "し", " ", "に", "が", "はち" ,"4", "× ", "2", "=", "8" },
                new List<string> { "し", " ", "さん", " ", "じゅうに" ,"4", "× ", "3", "=", "12" },
                new List<string> { "し", " ", "し", " ", "じゅうろく" , "4", "× ", "4", "=", "16" },
                new List<string> { "し", " ", "ご", " ", "にじゅう" ,"4", "× ", "5", "=", "20" },
                new List<string> { "し", " ", "ろく", " ", "にじゅうし" ,"4", "× ", "6", "=", "24" },
                new List<string> { "し", " ", "しち", " ", "にじゅうはち","4", "× ", "7", "=", "28" },
                new List<string> { "し", " ", "は", " ", "さんじゅうに","4", "× ", "8", "=", "32" },
                new List<string> { "し", " ", "く", " ", "さんじゅうろく","4", "×", "9", "=", "36" },
            };
            return questions;
        }
    }
