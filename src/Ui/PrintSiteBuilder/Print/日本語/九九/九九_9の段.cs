...
namespace PrintSiteBuilder.Print.日本語.九九
{
    public class 九九_9の段 : IPrint
    {
        ...
        public 九九_9の段()
        {
            PresentationId = "1D9G_dvL4S3OhockpbKgXTy3R7YIqy3PB1Nn9N6qNeiQ";
            PrintName = "九九(9の段)";
            PagesCount = 1;
        ...
        public List<List<string>> GetQuestions1()
        {
            var questions = new List<List<string>>
            {
                new List<string>{"く"," ","いち","が","く","9", "×", "1", "=", "9" },
                new List<string> { "く", " ", "に", " ", "じゅうはち" ,"9", "× ", "2", "=", "18" },
                new List<string> { "く", " ", "さん", " ", "にじゅうしち" ,"9", "× ", "3", "=", "27" },
                new List<string> { "く", " ", "し", " ", "さんじゅうろく" , "9", "× ", "4", "=", "36" },
                new List<string> { "く", " ", "ご", " ", "しじゅうご" ,"9", "× ", "5", "=", "45" },
                new List<string> { "く", " ", "ろく", " ", "ごじゅうし" ,"9", "× ", "6", "=", "54" },
                new List<string> { "く", " ", "しち", " ", "ろくじゅうさん","9", "× ", "7", "=", "63" },
                new List<string> { "く", " ", "は", " ", "しちじゅうに","9", "× ", "8", "=", "72" },
                new List<string> { "く", " ", "く", " ", "はちじゅういち","9", "×", "9", "=", "81" },
            };
            return questions;
        }
    }
