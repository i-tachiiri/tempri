...
{
    public class 労働基準法Repository
    {
        private readonly DocsService docsService;
        private readonly string documentId = "1AF9vf14r1H8PaG3jEmRIm7k0Em-OLN8OqN8BLUzSSeg"; // GoogleドキュメントのID
        private readonly string lawName = "労働基準法";

        public 労働基準法Repository(DocumentConnector docsConnecter)
        {
            docsService = docsConnecter.GetDocsService();
        }
        public void ExportHtml()
        {
            File.WriteAllText(@"C:\drive\work\web\Release\exam\w労働基準法.html", ConvertTextToHtml(GetWholeHtml(),"w労働基準法"));
            File.WriteAllText(@"C:\drive\work\web\Release\exam\s労働基準法.html", ConvertTextToHtml(GetSummaryHtml(),"s労働基準法"));
        }
